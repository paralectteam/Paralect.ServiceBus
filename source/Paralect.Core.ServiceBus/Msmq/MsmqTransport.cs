    ...
    public class MsmqTransport : ITransport
    {
        ...
        public ServiceBusMessage TranslateToServiceBusMessage(TransportMessage transportMessage)
        {
            ...
            if (!(messageObject is ServiceBusMessage))
                throw new TransportMessageDeserializationException(
                    $"Error when deserializing transport message. Object type is {messageObject.GetType().FullName} but should be of type TranportMessage");
